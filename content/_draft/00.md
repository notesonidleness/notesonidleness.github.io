...
- this is my review of working at NTI. some maybe harsh, but i just tell what I feel. i feel sorry if someone is hurt, but when i complain about something, it is nothing personal, it because i want everyone to be improved, to be better. i dont mention anyone goodness in here, because here i talk only my complain about myself. everything is my fault, i acknowledge it and i deeply sorry for that, but here's my little of complain review when i work in this company. i try to make it to the point so you dont need to waste your time read all of it. 


- at first i am messaged the work location pt econit perkasa beda dengan nama perusahaan sebenarnya, its suspicious, but no explanation.
- semuanya bekerja di 1 meja panjang, tidak ada ruang rapat untuk masing-masing tim atau proyek. 
  ...
  - i try to adapt, but i can't stand lots of distraction, multi tasking. researchers said, multi tasking is make you stupid
  - that's why i don't comfortable work in office.

- no formal onboarding process
  - no checklist.
  - i am just instructed to read the unreadable project reports.
  - they don't have training for new users.

- no knowledge management
  - i ask from beginning to anyone in office, but they say they don't have any.
...
- my first use of VISA
  ...
  - why i'm in contract but no account for me, its suspicious at first
...
- no ticket management
  ...
  - from beginning i ask why no task management, my manager said because users don't want to use. i knew it's not true. i'll explain next section.
...
- preparation for second meeting 
  - my manager give services management (ITSM?) template for report
  - we are asked to fill the list of our works, complete with time respond, time complete
  - we do're doin it manually look in whatsapp message, imagine the stupidity is it, how many lies we make. 
...
- second meeting with telkomsel users to present what we're working on a couple of last months. 
  ...
  - my manager looking for excuses, and users except tsel higher manager don't complain about the excuses. 
  - tsel higher management ask to use task management from them.
  - my manager said NTI have proper task management.
  - this is how i knew my manager is lying, because their task management is immature. he is not honest about users don't like use task management.
...
- first tutela request
  ...
  - first request is from new tsel user
    ...
    - user sendiri tidak benar-benar mengetahui data yg dibutuhkannya dan bagaimana proses pengolahan data. 
    - tidak ada sense of problem dari manager saya terkait hal ini, bukti kurang cakap dalam mendefinisikan masalah.
  - the stupidity is i need to query and download manually periodically, and send it via whatsapp because we was not be given servers at most of beginning time. 
...
-  ookla request:
  ...
  - this is the drawback of lack of skills in knowledge management, unproductive and redundant. 

- we borrow servers from other teams. 
  - how the fuck they easily give me root access.
  - then i use server to process all of it, rebuild custom code from them, install airflow, dbt, experiments much there without my manager know what I'm mostly doing.
...
- related to tsel env
  - offline meeting with mas ulin
    - i realized that tsel users are not that bright
      ...
      - they focus more results, even the results are questionable. 
      - they don't validate query or not even asking about data quality.
      - they just want it looks like it's working.
  - i hate VISA
    - slow welcome screen, random bugs like blank screen for long of minutes, sometimes lag even when connection has no issue.
  - lots of meeting suddenly
    - often waiting for each other
    - wasting time and unproductive

- i can't respect my manager, but i try
  - my managers ask much, over and over again. ENGINEER IS NOT A CUSTOMER SERVICES! 
  ...
  - he dont understand what im doing, how he knows value my work and performances, he's not respecting my works
  ...
  - he is clueless about data governance.
  - he can't create a colaborative team environment (use git, knowledge management)
    - he can't minimize single point of failure, when someone sick or no news, he mostly clueless.
  - he can't transparent everything.
    - he said bonus will be given in february, but no explanation until march salary.
    - i knew there are outing budget, but lack of transparency.
  - sometimes random request near midnight
    - ruining my sleep schedule, then im sick
  - when there's training event in telkomsel, he presents something he didnt understand with no enthusiasm, no one pay attention.

- nti is provide ERP services consultant even when their internal management is fucked up lol
  - grey area in work 24 hours contract 
    - we expect standby 24/7 but no compensation.
  - they say their culture is "kekeluargaan", but it's more resembelance to feodalism with lack of meritocracy.
  - lack of feedback mechanism, no performance reviews
  - lack of skills in publication of information and communication.
    - information about the chart of organization, vision, mission, values, culture, policy, cant be available at any time. 
    - not provide information regard benefits: counseling, sports, community interest/hobbies, etc.
  - my laptop is broken and im sick but no help facility
  - they expect 12 months commitment, and fine if we resign before it, because they can't run company well by providing good environment so employee could stay longer.
    - punishment is a lowly way to maintain power.
...
- my realization
  ...
  - culture vendor BUMN yg saya lihat adalah seperti bermain sumput-sumputan (sembunyi-sembunyi). tidak ada transparansi dalam informasi perusahaan, karena memang begitu budayanya, budaya vendor yg sangat-sangat desperate butuh pekerjaan, sehingga mereka khawatir akan tergantikan apabila client nya mengetahui apa yang diketahuinya. 
  - maybe only me who sense many of these are problems, if thats the case, then im fully wrong. 
  - maybe im a minority like in the indonesia's election, if many comfort with status quo and doesnt have an intention to improve or change, then the minority is the one who should accept it, or leave it. 
  - when there is a lack of transparency its hard for company to grow, it will be cursed with stagnation. stagnation is bad in islam. 
  - this company ini menyedihkan menurut saya. and i feel sorry about that. and i hope that it will be better by the time i leave this company.

thanks for reading. i have no mean to harm anyone, i just pro growth as islam pushing fastabiqul khoirat, so i need to elaborate all of these.

thanks again anyone. so long and thanks for all the fish.



assalamualaikum wr wb.

teman-teman izin leave ya, 

terima kasih banyak atas semuanya dan mohon maaf apabila saya ada kesalahan.



di masa akhir saya korbankan integritas saya dengan menunjukkan simulasi manajemen bencana. Saya ingin berbagi skenario untuk menghindari risiko manajemen semacam ini di masa mendatang.

Inilah pentingnya manajemen pengetahuan dari awal, kolaborasi, transparansi, dan meminimalkan ketergantungan pada satu aspek saja. Manajer setidaknya harus mengetahui apa yang dilakukan oleh staf teknik, bukan hanya memberikan instruksi semata. Jika perusahaan tidak dapat mengatasi bencana kecil seperti ini, itu menunjukkan kurangnya perencanaan dan tata kelola organisasi yang baik.

Simulasi ini diharapkan dapat meningkatkan manajemen dan kepemimpinan perusahaan. Bagaimana cara mengelola proyek kompleks yang lebih besar dengan aman, jika perusahaan tidak mampu mengatasi bencana kecil seperti ini?

Musibah dan bencana bisa datang kapan saja. Kita perlu siap menghadapi 'black swan event'...

Mari bersama-sama merefleksikan, muhasabah, dan melakukan retrospeksi. Selamat memecahkan masalah, Mas."